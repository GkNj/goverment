    ...
    if (window.Select2 === b) {
        ...
        c = {
            ...
            bind: function (a) {
                ...
                var o, p, q, b = this.container.offset(), c = this.container.outerHeight(!1),
                    d = this.container.outerWidth(!1), e = this.dropdown.outerHeight(!1),
                    f = a(window).scrollLeft() + a(window).width(), g = a(window).scrollTop() + a(window).height(),
                    h = b.top + c, i = b.left, j = g >= h + e, k = b.top - e >= this.body().scrollTop(),
                    l = this.dropdown.outerWidth(!1), m = f >= i + l, n = this.dropdown.hasClass("select2-drop-above");
                ...
                var g, i, d = this.search, e = this.results, f = this.opts, h = this, j = d.val(),
            ...
            createContainer: function () {
                ...
                var a = this.getVal(), b = this.results.find(".select2-result"),
